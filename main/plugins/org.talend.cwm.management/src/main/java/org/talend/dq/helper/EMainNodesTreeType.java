...
public enum EMainNodesTreeType {
    ...
    DATAPROFILING(0, ERepositoryObjectType.TDQ_DATA_PROFILING),
    LIBRARIES(1, ERepositoryObjectType.TDQ_LIBRARIES),
    CONTEXTS(2, ERepositoryObjectType.CONTEXT),
    METADATA(3, ERepositoryObjectType.METADATA),
    RECYCLE_BIN(4, ERepositoryObjectType.RECYCLE_BIN),
    OTHERS(5, null);
    ...
    private EMainNodesTreeType(int index, ERepositoryObjectType type) {
        this.index = index;
        this.type = type;
    }
